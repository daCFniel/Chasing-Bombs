...
{      
                        ...
                        if(clickedPanel.getComponentCount() == 1) { // getComponentCount() returns 1 for squares with bomb planted, it's 0 for empty squares
                            ...
                            switch(difficulty) {
                                case 1: // easy difficulty
                                    if(score == 5) { // score 5 to win
                                        displayWinningMessage();
                                    }
                                    break;
                                case 2: // intermediate difficulty
                                    if(score == 7) { // score 7 to win
                                        displayWinningMessage();
                                    }
                                    break;
                                case 3: // difficult difficulty
                                    if(score == 9) { // score 9 to win
                                        displayWinningMessage();
                                    }
                                    break;
                            }
    ...
    public void displayWelcomeMessage()
    {
        ...
        +"[Easy] - score 5 [Intermediate] - score 7 [Difficult] - score 9 ~ to win<br><br>"
     ...
     * that indicates win.  
     * and make the game inactive.
     */
    public void displayWinningMessage()
    {
        gameIsActive = false;
        playerScore.setText("You won! You got "+score+" points");
        JOptionPane.showMessageDialog(null,"You won!","Congratulations!",
        JOptionPane.INFORMATION_MESSAGE,new ImageIcon("star-50.png"));    
    }
            ...
            switch(event.getActionCommand()) {
                ...
                case "Difficult":
                    if(difficulty != 3) {
                        ...
                        +"Score 9 points to win the game.</html>");
                    }
                    break;
            }
        }    
